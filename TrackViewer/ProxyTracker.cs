...
namespace TrackViewer
{
    public class ProxyTracker
    {
        ...
        private ProxyTracker()
        {
            ...
            System.ServiceModel.EndpointAddress address = new System.ServiceModel.EndpointAddress("http://127.0.0.1:81/TrackService.svc"); //new System.ServiceModel.EndpointAddress("http://trackviewerservice.cloudapp.net/TrackService.svc");// 
